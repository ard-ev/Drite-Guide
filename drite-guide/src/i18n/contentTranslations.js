...
const CITY_DESCRIPTIONS = {
  de: {
    tirana: 'Albaniens lebendige Hauptstadt mit Cafes, Kultur, Nachtleben und Ausflügen in die Stadt.',
    shkoder: 'Historische Stadt im Norden, bekannt für Kultur, Radfahren und die Nähe zu den Albanischen Alpen.',
    vlore: 'Ein Küstentor, an dem Adria und Ionisches Meer aufeinandertreffen.',
    durres: 'Eine Stadt am Meer mit langen Stränden, römischer Geschichte und schneller Verbindung nach Tirana.',
    ksamil: 'Ein berühmtes Strandziel im Süden mit türkisfarbenem Wasser und kleinen Inseln.',
    dhermi: 'Ein Riviera-Hotspot, bekannt für Strände, Nachtleben und malerische Bergstrassen.',
    lin: 'Ein ruhiges Dorf am Ohridsee mit entspannten Uferblicken.',
    theth: 'Ein Bergdorf, berühmt für Wanderungen, alpine Landschaften und traditionelle Gästehäuser.',
    gjirokaster: 'Eine UNESCO-Steinstadt mit osmanischer Architektur und Blick auf die Burg.',
    korca: 'Ein kulturelles Zentrum im Südosten, bekannt für Essen, Serenaden und entspannten Stadtrhythmus.',
    berat: 'Die Stadt der tausend Fenster mit vielschichtiger Geschichte und Charme am Fluss.',
    lezhe: 'Eine Stadt im Norden, die Sehenswürdigkeiten im Inland mit nahen Stränden und Lagunen verbindet.',
    shengjin: 'Ein wachsendes Strandziel an der Nordküste.',
    velipoje: 'Ein breiter Sandstrand nahe Naturreservaten und der Grenze zu Montenegro.',
    saranda: 'Eine sonnige Stadt am Ionischen Meer, beliebt für Strände, Promenaden und Tagesausflüge in den Süden.',
    kruja: 'Eine historische Stadt am Hang, bekannt für Skanderbeg, den Basar und die Burg.',
    himare: 'Ein Riviera-Ausgangspunkt für schöne Strände, Buchten und entspanntes Küstenleben.',
  },
  sq: {
...
const PLACE_DESCRIPTIONS = {
  de: {
    re1: 'Mullixhiu bietet eine moderne Interpretation traditioneller albanischer Küche mit lokalen Zutaten und saisonalen Rezepten. Ein Muss in Tirana für ein authentisches und raffiniertes Essen.',
    re2: 'Ein gemütliches Gartenrestaurant mit traditionellen albanischen Gerichten aus frischen, lokalen Zutaten und einem authentischen, feinen Esserlebnis.',
    ca1: 'Ein einzigartiges Cafe mit albanischer Kultur, gutem Kaffee und auch Alkohol ;)',
    ba1: 'Beliebte Cocktailbar im Blloku mit lebendiger Atmosphäre.',
    ...
    re3: 'Authentische albanische Küche in einem traditionellen Haus.',
    ...
    re4: 'Fischrestaurant mit schönem Meerblick.',
    ca3: 'Perfekter Ort für Kaffee an der Promenade.',
    ...
    ho7: 'Modernes Hotel in Strandnähe.',
    ...
    ho10: 'Komfortables Hotel in Strandnähe in Shengjin.',
    be7: 'Der grösste Strand Albaniens mit vielen Resorts und Restaurants.',
    ...
    re6: 'Berühmtes Seafood-Restaurant nahe dem Strand.',
    ca5: 'Entspanntes Cafe mit Meerblick.',
    ba11: 'Beachbar mit Musik und Cocktails.',
    ho11: 'Modernes Hotel in Strandnähe.',
    be12: 'Berühmt für türkisfarbenes Wasser und kleine Inseln direkt vor der Küste.',
    ...
    ca7: 'Schönes Cafe mit Desserts und Kaffee.',
    ba16: 'Berühmter Beachclub mit Partys und Drinks.',
    ho13: 'Hotel am Meer mit Apartments und privatem Strandzugang.',
    ho14: 'Stilvolles Strandresort mit Infinity-Pool.',
    be16: 'Einer der beliebtesten Strände Albaniens mit kristallklarem Wasser.',
    be17: 'Trendiger Strand mit Beachclubs und beeindruckenden Sonnenuntergängen.',
    be18: 'Berühmt für Nachtleben und Strandpartys.',
    be19: 'Ein abgelegenes Paradies, erreichbar durch eine Canyon-Wanderung.',
    ho15: 'Strandresort mit entspannter und trendiger Atmosphäre.',
    ho16: 'Elegantes Hotel mit Panoramablick auf das Meer.',
    ho17: 'Modernes Strandresort mit lebendiger Atmosphäre.',
  },
  sq: {
